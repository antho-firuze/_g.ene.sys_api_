...
// $route['api/v1/test']['POST'] = 'test/restapi/';
// $route['api/v1/test/(:any)']['GET'] = 'module_name/read/$1';
// $route['api/v1/test/(:any)']['PUT'] = 'module_name/update/$1';
// $route['api/v1/test/(:any)']['DELETE'] = 'module_name/delete/$1';
