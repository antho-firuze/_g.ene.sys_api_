...
class Frontend_Model extends Z_Model
{
	...
	function getMenu($org_id)
	{
		...
		from (
			...
			where am.is_active = '1' and am.is_deleted = '0' and am.org_id = $org_id
		) am1
		left join (
			select am.* from w_menu am 
			where am.is_active = '1' and am.is_deleted = '0' and am.org_id = $org_id
	...
	function getDashboard($org_id)
	{
		...
		$params['where']	= "ad.is_active = '1' and ad.is_deleted = '0' and ad.org_id = $org_id";
	...
	function getInfo($params)
	{
		...
		$params['where']	= "ai.is_active = '1' and ai.is_deleted = '0'";
